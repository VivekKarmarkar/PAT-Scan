"""
U-Net Training Script with Grid Search - v4
Performs grid search over hyperparameters, then trains with best config
...
print("="*70)
print("U-NET INVERSE PROBLEM TRAINING - V4 WITH GRID SEARCH")
print("="*70)
...
fig.suptitle(f'Final Results After {num_iterations} Iterations (Grid Search Optimized)', 
             fontsize=16, fontweight='bold', y=0.98)
